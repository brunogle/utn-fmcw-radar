...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "AXIS_STREAM_LENGTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.AXIS_STREAM_LENGTH { PARAM_VALUE.AXIS_STREAM_LENGTH } {
	# Procedure called to update AXIS_STREAM_LENGTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.AXIS_STREAM_LENGTH { PARAM_VALUE.AXIS_STREAM_LENGTH } {
	# Procedure called to validate AXIS_STREAM_LENGTH
	return true
}
...
proc update_MODELPARAM_VALUE.AXIS_STREAM_LENGTH { MODELPARAM_VALUE.AXIS_STREAM_LENGTH PARAM_VALUE.AXIS_STREAM_LENGTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.AXIS_STREAM_LENGTH}] ${MODELPARAM_VALUE.AXIS_STREAM_LENGTH}
}
