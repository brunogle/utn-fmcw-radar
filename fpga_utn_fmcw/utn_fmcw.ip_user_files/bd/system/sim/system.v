...
module system
  ...
  wire [12:0]radar_sweep_ctrl_0_BRAM_PORT_ADDR;
  ...
  system_axi_gpio_0_0 axi_gpio_0
       (.gpio_io_i(radar_sweep_ctrl_0_m_axis_tdata),
        .s_axi_aclk(pll_0_clk_out1),
  ...
  system_blk_mem_gen_0_2 blk_mem_gen_0
       (.addra(axi_bram_ctrl_0_BRAM_PORTA_ADDR),
        .addrb({1'b0,radar_sweep_ctrl_0_BRAM_PORT_ADDR}),
        ...
        .web(radar_sweep_ctrl_0_BRAM_PORT_WE));
  ...
  system_radar_sweep_ctrl_0_10 radar_sweep_ctrl_0
       (.bram_addr(radar_sweep_ctrl_0_BRAM_PORT_ADDR),
        ...
        .bram_dout({1'b0,radar_sweep_ctrl_0_BRAM_PORT_DOUT}),
